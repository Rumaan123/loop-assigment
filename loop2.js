...
console.log("Random Number (for development purposes): ".concat(randomNumber)); // Use template literals for cleaner code
...
while (i < guesses.length && !isCorrectGuess) {
    ...
    console.log("User guessed: ".concat(currentGuess)); // Use template literals
